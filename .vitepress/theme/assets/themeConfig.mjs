...
export const themeConfig = {
  ...
  aside: {
    ...
    hello: {
      enable: true,
      text: "<strong>这里是一个专属于我自己的空间，用于记录我的学习历程和成长点滴。不论是新知识的探索、技能的提升，还是经验的总结和心得的分享，我都会在这里整理和记录。通过文字、图片甚至是代码，我希望能够清晰地回顾过去的努力，同时为未来的自己提供有价值的参考。这不仅仅是一个记录的地方，更是我自我激励、反思和成长的平台。</strong>",
    },
    // 目录
    toc: {
      enable: true,
